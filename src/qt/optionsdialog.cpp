    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new RapecoinUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->rapecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Rapecoin."), QMessageBox::Ok);
