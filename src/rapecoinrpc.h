...
#ifndef _RAPECOINRPC_H_
#define _RAPECOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Rapecoin is not connected
...
/**
 * Rapecoin RPC command dispatcher.
 */
class CRPCTable
{
private:
