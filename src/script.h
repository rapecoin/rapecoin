...
#ifndef H_RAPECOIN_SCRIPT
#define H_RAPECOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CRapecoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Rapecoin always counted CHECKMULTISIGs
